...
function App(){
  ...
  async function CarregaAPI(){
    ...
    //setAtletas(dados.atletas);


    //const testeOrdenado1 = teste.data.atletas.sort((a,b) => a.minimo_para_valorizar-b.minimo_para_valorizar)

    //const testeOrdenado = dados.data.atletas.sort((a,b) => a.minimo_para_valorizar-b.minimo_para_valorizar)

    //console.log(testeOrdenado1);
